...
function initToolbox (ipcRenderer){
    ...
    // edit module bar
    // edit_module_button.addEventListener('click', function() {
    //     ipcRenderer.send('add module', {
    //         name: edit_module_name.value,
    //         type: edit_module_type.value,
    //         address: edit_module_address.value
    //     })
    // })
}

function initEditBox (ipcRenderer, module_json){
