...
def add_module(module_type):
    global MGK
    print(MGK + "2" + MGK + "modify.exe" + MGK + "add_module" + MGK + module_type)

def remove_module(module_UUID):
    global MGK
    print(MGK + "2" + MGK + "modify.exe" + MGK + "remove_module" + MGK +  module_UUID)

def change_parameter(module_UUID, parameter_name, new_value):
    global MGK
    print(MGK + "2" + MGK + "modify.exe" + MGK + "change_parameter"  + MGK + module_UUID + MGK + parameter_name + MGK + new_value)
